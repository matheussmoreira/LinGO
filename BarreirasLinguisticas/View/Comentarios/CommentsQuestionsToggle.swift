...
struct CommentsQuestionsToggle: View {
    ...
    var body: some View {
        VStack {
            ...
            ToggleBar(questions_selected: $questions_selected)
...
//                MessageOfEmpty(message: "No questions for this post 😕")
//            }
//            else {
...
//
//            if comments.isEmpty {
//                MessageOfEmpty(message: "No comments for this post 😕")
//            }
//            else {
//
//                ScrollView(.vertical, showsIndicators: false) {
